    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 md:pt-[60px]">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
                <h1 className="text-2xl md:text-3xl font-bold text-purple-800 mb-6 text-center">Create Booking</h1>
                ...
                <div className="bg-blue-50 p-4 rounded-lg mb-6">
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-lg font-medium text-gray-700">
                            Duration: <span className="font-bold text-blue-600">{daysBetween}</span> {daysBetween === 1 ? "day" : "days"}
                        </p>
                    </div>
                </div>
